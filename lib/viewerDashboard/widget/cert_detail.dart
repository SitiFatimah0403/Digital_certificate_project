...
class CertDetail extends StatefulWidget {
  final Map<String, dynamic> cert;

  const CertDetail({super.key, required this.cert});

  @override
  State<CertDetail> createState() => _CertDetailPageState();
}

class _CertDetailPageState extends State<CertDetail> {
